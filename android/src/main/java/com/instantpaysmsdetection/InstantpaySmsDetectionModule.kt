...
@ReactModule(name = InstantpaySmsDetectionModule.NAME)
class InstantpaySmsDetectionModule(reactContext: ReactApplicationContext) : NativeInstantpaySmsDetectionSpec(reactContext) {
	...
	override fun requestSmsConsent(
	...
	override fun simCardPhoneNumber(
		subscriptionId: Double,
		promise: Promise
	) {
		responsePromise = promise
	...
	/*fun sendWithCallback(callback: Callback) {
		val response = "Callback response from Android"
